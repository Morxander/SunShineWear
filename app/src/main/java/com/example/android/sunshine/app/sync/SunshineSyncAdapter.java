...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if(i == 0){
                    sendToWear(high, low, weatherId, getContext());
                }
            }
    ...
    static private void sendToWear(double weather_h, double weather_s, int weather_id, Context context){
        GoogleApiClient mGoogleApiClient = new GoogleApiClient.Builder(context)
                .addApi(Wearable.API)
                .build();
        mGoogleApiClient.connect();
        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/weather");
        putDataMapRequest.getDataMap().putDouble("weather_h",Math.round(weather_h));
        putDataMapRequest.getDataMap().putDouble("weather_s",Math.round(weather_s));
